    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="font-display text-2xl font-semibold text-ro-pri">
              Command Chamber
            </h1>
            <p className="mt-0.5 text-sm text-ro-sec">
        ...
        {/* Today's Ritual — focus input */}
        <div className="ro-card p-5">
          <div className="mb-3 flex items-center gap-2">
            <Target size={12} className="text-ro-pink" aria-hidden="true" />
            <span className="text-[10px] font-bold uppercase tracking-[0.12em] text-ro-pink/60">
              Today's Ritual
            </span>
          </div>
          ...
          <input
            ...
            className="w-full bg-transparent font-display text-lg font-medium text-ro-pri placeholder-ro-muted/50 outline-none"
          />
          <p className="mt-2 text-xs text-ro-muted">Saved for this session only.</p>
        </div>
        ...
        <section aria-labelledby="stats-heading">
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-5">
            {/* Momentum */}
            <div className="ro-card col-span-1 flex flex-col items-center justify-center gap-2.5 border-l-2 border-l-ro-pink p-5">
              <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-ro-pink/60">
                Momentum
              </span>
        ...
        <section aria-labelledby="quick-actions-heading">
          <h2
            ...
            className="mb-3 text-[9px] font-bold uppercase tracking-[0.12em] text-ro-pink/40"
          >
            Quick Actions
          </h2>
